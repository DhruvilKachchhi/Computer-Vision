...
├── image_blur.py        # Main implementation script
...
```cmd
python image_blur.py --sigma 2.0 --kernel-size 15
```

**Available Options:**
- `--sigma`: Standard deviation for Gaussian kernel (default: 4.0)
- `--kernel-size`: Size of Gaussian kernel, must be odd (default: 25)

### Examples

```cmd
# Use a smaller kernel for subtle blurring
python image_blur.py --sigma 1.0 --kernel-size 9

# Use a larger kernel for strong blurring
python image_blur.py --sigma 3.0 --kernel-size 21

# Process with custom parameters
python image_blur.py --sigma 2.5 --kernel-size 17
```
